...
class _composite_rays(Function):
    ...
    def forward(ctx, n_alive, n_step, rays_alive, rays_t, sigmas, rgbs, ambient, deltas, weights_sum, ambient_sum, depth, image, T_thresh=1e-2):
        ...
        In-place Outputs:
            ...
            image: float, [N, 3], the RGB channel (after multiplying alpha!)
        '''
        _backend.composite_rays(n_alive, n_step, T_thresh, rays_alive, rays_t, sigmas, rgbs, ambient, deltas, weights_sum, ambient_sum, depth, image)
        return tuple()
