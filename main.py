...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr_srnet', type=float, default=0.00002, help="initial learning rate for srnet")
    ...
    if opt.test:
        ...
        # temp fix: for update_extra_states
        model.aud_features = train_loader._data.auds #[1*L, 29, 16]
        model.eye_area = train_loader._data.eye_area #[1*L,1]
